...
export function MenuHeader({
  ...
  if (isSoul) {
    return (
      <div className="soul-header relative overflow-hidden bg-[#1c1915] text-[#f5f0e8]">
        <div className="mx-auto grid max-w-6xl gap-5 px-4 py-6 sm:gap-6 sm:py-8 lg:min-h-[420px] lg:grid-cols-[0.85fr_1.1fr_1fr] lg:items-center lg:gap-8 lg:py-10">
          <div className="relative flex min-h-56 items-center justify-center border-y-2 border-[#d4af37] bg-[#252018] px-5 py-8 shadow-[inset_0_0_0_1px_rgba(212,175,55,0.25)] sm:min-h-64 lg:min-h-72 lg:px-6 lg:py-10">
            {logo && (
            ...
            <div className="absolute bottom-5 text-center sm:bottom-7 lg:bottom-8">
              <p className="text-xl italic text-[#d4af37] sm:text-2xl">Menu</p>
              <p className="text-xs tracking-[0.32em] text-[#a89f8f] sm:text-sm sm:tracking-[0.35em]">SOUL</p>
            </div>
          </div>

          {coverImage && (
            <div className="relative min-h-56 overflow-hidden border border-[#3d3528] bg-[#252018] shadow-xl sm:min-h-72 lg:min-h-[340px]">
              <Image
                src={coverImage}
                alt={restaurantName}
                fill
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1c1915]/55 via-transparent to-transparent" />
            </div>
          )}

          <div className="space-y-4 lg:space-y-5">
            <div>
              <p className="text-xl italic text-[#d4af37] sm:text-2xl">{restaurantName}</p>
              <h1 className="mt-2 text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">{name}</h1>
              {description && <p className="mt-3 max-w-xl text-sm leading-7 text-[#a89f8f] sm:mt-4 sm:text-base">{description}</p>}
            </div>

            {hours && (
              <div className="flex flex-wrap items-center gap-2 text-xs text-[#a89f8f] sm:text-sm">
            ...
            <div className="flex flex-wrap gap-2">
              {branch.whatsapp && (
                <Button variant="outline" size="sm" asChild className="h-9 border-[#3d3528] bg-[#252018] text-xs text-[#f5f0e8] sm:text-sm hover:bg-[#2a2520]">
      ...
      <div className="antika-header relative overflow-hidden bg-[#f5eee3] text-[#2a160f]">
        <div className="mx-auto grid max-w-6xl gap-5 px-4 py-6 sm:gap-6 sm:py-8 lg:min-h-[420px] lg:grid-cols-[0.85fr_1.1fr_1fr] lg:items-center lg:gap-8 lg:py-10">
          <div className="relative flex min-h-56 items-center justify-center border-y-2 border-[#b67b31] bg-[#fffaf1] px-5 py-8 shadow-[inset_0_0_0_1px_rgba(182,123,49,0.25)] sm:min-h-64 lg:min-h-72 lg:px-6 lg:py-10">
            ...
            <div className="absolute bottom-5 text-center sm:bottom-7 lg:bottom-8">
              <p className="text-xl text-[#b67b31] sm:text-2xl">Menu</p>
          ...
          <div className="space-y-4 lg:space-y-5">
            <div>
              <p className="text-xl text-[#b67b31] sm:text-2xl">{restaurantName}</p>
              <h1 className="mt-2 text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">{name}</h1>
